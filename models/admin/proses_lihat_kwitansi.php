...
if($pict == '') {
    $bankbni->edit("UPDATE tb_transaksi SET no_voucher='$no_voucher', tanggal='$tanggal', deskripsi='$deskripsi', jenis='$jenis', jumlah='$jumlah', lokasi_dana='$lokasi_dana', id_kategori='$id_kategori' WHERE id_transaksi='$id_transaksi'");
    ...
    if($upload) {
        $bankbni->edit("UPDATE tb_transaksi SET no_voucher='$no_voucher', tanggal='$tanggal', deskripsi='$deskripsi', jenis='$jenis', jumlah='$jumlah', lokasi_dana='$lokasi_dana', id_kategori='$id_kategori', kwitansi_pendukung='$kwitansi_pendukung' WHERE id_transaksi='$id_transaksi'");
    echo "<script>window.location='?page=bank_bni';</script>";
    } else {
