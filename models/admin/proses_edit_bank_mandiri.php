...
if($pict == '') {
    $bankmandiri->edit("UPDATE tb_transaksi SET no_voucher='$no_voucher', tanggal='$tanggal', deskripsi='$deskripsi', jenis='$jenis', jumlah='$jumlah', lokasi_dana='$lokasi_dana' WHERE id_transaksi='$id_transaksi'");
    ...
    if($upload) {
        $bankmandiri->edit("UPDATE tb_transaksi SET no_voucher='$no_voucher', tanggal='$tanggal', deskripsi='$deskripsi', jenis='$jenis', jumlah='$jumlah', lokasi_dana='$lokasi_dana', kwitansi_pendukung='$kwitansi_pendukung' WHERE id_transaksi='$id_transaksi'");
    echo "<script>window.location='?page=bank_mandiri';</script>";
    } else {
