                        ...
                        <ul class="mobile-menu-nav">
                            ...
                            <li><a data-toggle="collapse" data-target="#democrou" href="#">Laporan</a>
                                <ul id="democrou" class="collapse dropdown-header-top">
                                    <li><a href="?page=laporan_keseluruhan">Keseluruhan</a></li>
                                    <li><a href="?page=laporan_per_kategori">Per Kategori</a></li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="tab-content custom-menu-content">
                    ...
                    <div id="Interface" class="tab-pane notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            <li><a href="?page=laporan_keseluruhan">Keseluruhan</a>
                            </li>
                            <li><a href="?page=laporan_per_kategori">Per Kategori</a>
                            </li>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="footer-copy-right">
                    <p>Copyright © 2018. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.
                    </p>
                </div>
            </div>
        </div>
