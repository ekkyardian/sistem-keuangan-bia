                                    ...
                                    <div class="modal-dialog modals-default">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" text-align="center">Tambah Transaksi: Kas</h4>
                                                <br/>
                                            </div>
                            ...
                            <table id="datatables" class="table table-striped table-hover">
                                ...
                                while ($data = $tampil->fetch_object()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a id="edit_kas" data-toggle="modal" data-target="#edit"
                                            ...
                                            <a href="?page=kas&act=del&id=<?php echo $data->id_transaksi; ?>"
