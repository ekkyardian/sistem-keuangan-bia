...
if ($_GET['periode_bulan'] == 1) {
    ...
    $bulan_saldo_s = '12';
    $tahun_saldo_s = $_GET['periode_tahun'] - 1;
} elseif ($_GET['periode_bulan'] == 2) {
    $nama_bulan = "FEBRUARI";
    $bulan_sebelumnya = "JANUARI";
    $bulan_saldo_s = '01';
    $tahun_saldo_s = $_GET['periode_tahun'];
...
$bulan_saldo = $_GET['periode_bulan'];
$tahun_saldo = $_GET['periode_tahun'];
$sumber_dana = $_GET['sumber'];
?>
...
<table class="table">
    ...
    <tr align="center">
        ...
        <td colspan="5" class="style_content_center">
            ...
            <p class="kop2">LAPORAN KEUANGAN <?php echo ucwords(strtoupper($_GET['sumber'])); ?></p>
    ...
    <tr class="style_table">
        ...
        <td class="style_content_right style_table">
            <strong>
                <?php
                $data_saldo = $laporankeseluruhan->tampil_saldo($bulan_saldo_s, $tahun_saldo_s, $sumber_dana);
    ...
    $kredit = 0;
    $balance = 0;
    $tampil = $laporankeseluruhan->tampil_kas($bulan_saldo, $tahun_saldo, $sumber_dana);
    ...
    <tr class="style_table">
        ...
        <td class="style_content_right style_table"><strong><?php echo number_format($saldo, 0, ",", "."); ?></strong></td>
    </tr>
    </tfoot>
</table>
<?php
