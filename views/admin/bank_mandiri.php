                    ...
                    <div class="row">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>&nbsp;&nbsp;</td>
                                                <td><button type="submit" class="btn btn-primary" name="go">Go</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <div class="modal-dialog modals-default">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" text-align="center">Tambah Transaksi: Bank Mandiri</h4> <br />
                                            </div>
                                                ...
                                                <table class="table table-sc-ex">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <input type="hidden" name="lokasi_dana" class="form-control" id="lokasi_dana" value="Bank Mandiri">
                                                        </tr>
                                                        <tr>
                                        ...
                                        if(isset($_POST['tambah'])) {
                                            ...
                                            if($upload) {
                                                $bankmandiri->tambah($no_voucher, $tanggal, $deskripsi, $jenis, $jumlah, $lokasi_dana, $id_kategori, $kwitansi_pendukung);
                        ...
                        <div class="modal-dialog modals-default">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    <h4 class="modal-title" text-align="center">Edit Transaksi: Bank Mandiri</h4> <br />
                                </div>
