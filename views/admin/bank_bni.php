                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form name="bank_bni_show_by" action="" method="get" class="form-custom">
                                                ...
                                                if (isset($_POST['update_saldo'])) {
                                                    ...
                                                    $bankbni->update_saldo($periode_bulan, $periode_tahun, $lokasi_dana);
                                    ...
                                    <div class="modal-dialog modals-default">
                                        <div class="modal-content">
                                            ...
                                            if (isset($_POST['tambah'])) {
                                                ...
                                                if ($upload) {
                                                    $bankbni->tambah($no_voucher, $tanggal, $deskripsi, $jenis, $jumlah, $lokasi_dana, $kwitansi_pendukung);
                                                    header("location: index.php?page=bank_bni");
                                                } else {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" title="Lihat kwitansi" class="btn btn-info btn-xs"
                                                    data-toggle="modal" data-target="#lihatkwitansi<?php echo $ganti_id; ?>"><i
                                                        class="fa fa-eye"></i></button>
                                            <div class="modal fade" id="lihatkwitansi<?php echo $ganti_id; ?>" role="dialog">
                                                <div class="modal-dialog modals-default">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                        ...
                                        <td>
                                            <a id="edit_bank_bni" data-toggle="modal" data-target="#edit"
                                            ...
                                            <a href="?page=bank_bni&act=del&id=<?php echo $data->id_transaksi; ?>"
